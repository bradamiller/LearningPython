...
## Part 1 · What the Navigator needs
...
## Part 3 · `drive_path` and clearing the intersection
...
## Part 4 · Trace it, then integrate

Before running, trace `[(1,0), (1,1)]` from (0,0) heading 0 (N):
