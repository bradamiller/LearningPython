...
Categories: BUG, BLOCKED, ANSWERS, CONVENTION, MEDIA. They are plain words with
no regex metacharacters, because VS Code's Todo Tree drops tags straight into a
regex and does not document escaping.
